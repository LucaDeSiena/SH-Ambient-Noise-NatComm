...
%   Area: 20x20 km
%   Dominant Frequency: 0.7 Hz
%   Filtered Frequency: 0.7 Hz
%   Frequency: 0.7 Hz
...
%% 
% Here you need to insert the coordinates of the sources. You can either
% set it to a point (1) or a circle around the area (2)
optionSource                        =   3;
